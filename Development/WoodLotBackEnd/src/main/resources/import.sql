...
/*Utenti*/
INSERT INTO utente (id,nome, cognome, email, password) VALUES(1,"Alessia","Ture", "alessiature@gmail.com", MD5("briciola"));
INSERT INTO utente (id,nome, cognome, email, password) VALUES(2,"Raffaella","Spagnuolo", "raffaellaspaguonolo@gmail.com",MD5("frida"));
INSERT INTO utente (id,nome, cognome, email, password) VALUES(3,"Salvatore","Di Sanza", "salvatoredisanza@gmail.com", MD5("salvatore"));
INSERT INTO utente (id,nome, cognome, email, password) VALUES(4,"Antonio","Avino", "antonioavino@gmail.com", MD5("brici"));
INSERT INTO utente (id,nome, cognome, email, password) VALUES(5,"Elpidio","Mazza", "elpidiomazza@gmail.com", MD5("raffy"));
INSERT INTO utente (id,nome, cognome, email, password) VALUES(6,"Mario","Rossi", "mariorossi@gmail.com", MD5("password"));
INSERT INTO utente (id,nome, cognome, email, password) VALUES(7,"Salvatore","Esposito", "salvatoreesposito@gmail.com", MD5("salvatore"));
INSERT INTO utente (id,nome, cognome, email, password) VALUES(8,"Antonio","Gravino","antoniogravino@gmail.com", MD5("antonio"));
INSERT INTO utente (id,nome, cognome, email, password) VALUES(9,"Ester","Esposito", "esteresposito@gmail.com", MD5("ester"));
INSERT INTO utente (id,nome, cognome, email, password) VALUES(10,"Mario","Contaldi", "mariocontaldi@gmail.com", MD5("password"));

/*Contadini*/

INSERT INTO contadino (id, nome, cognome, data_di_nascita, email, password, coordinate_geografiche, swift, titolare_conto) VALUES(1, "Pedro", "Garica", "1984-05-03", "pedrogarcia@gmail.com", MD5("alessiature01"), "Guatemala", "UNCRITMM789", "Pedro Garcia");
INSERT INTO contadino (id, nome, cognome, data_di_nascita, email, password, coordinate_geografiche, swift, titolare_conto) VALUES(2, "Carlos", "Lopez", "1975-03-02", "carloslopez@gmail.com", MD5("alessiature01"), "Guatemala", "UNCRITMM749", "Carolos Lopez");
INSERT INTO contadino (id, nome, cognome, data_di_nascita, email, password, coordinate_geografiche, swift, titolare_conto) VALUES(3, "Maria", "Santos", "1998-07-23", "mariasantos@gmail.com", MD5("alessiature01"), "Guatemala", "UNCRITMM779", "Maria Santos");
INSERT INTO contadino (id, nome, cognome, data_di_nascita, email, password, coordinate_geografiche, swift, titolare_conto) VALUES(4, "Manuel", "Perez", "1999-10-23", "manuelperez@gmail.com", MD5("alessiature01"), "Guatemala", "UNCRITMZ689", "Manuel Perez");
INSERT INTO contadino (id, nome, cognome, data_di_nascita, email, password, coordinate_geografiche, swift, titolare_conto) VALUES(5, "Carmen", "Castillo ", "1964-02-23", "carmencastillo@gmail.com", MD5("alessiature01"), "Guatemala", "UNCRITTT789", "Carmen Castillo");
INSERT INTO contadino (id, nome, cognome, data_di_nascita, email, password, coordinate_geografiche, swift, titolare_conto) VALUES(6, "Gloria", "Diaz", "1954-02-23", "gloriadiaz@gmail.com", MD5("alessiature01"), "Guatemala", "UNCRITMM789", "Gloria Diaz");
INSERT INTO contadino (id, nome, cognome, data_di_nascita, email, password, coordinate_geografiche, swift, titolare_conto) VALUES(7, "Alejandro", "Escobar", "2002-02-23", "alejandroescobar@gmail.com", MD5("alessiature01"), "Guatemala", "UNCRITRZ789", "Alejandro Escobar");
INSERT INTO contadino (id, nome, cognome, data_di_nascita, email, password, coordinate_geografiche, swift, titolare_conto) VALUES(8, "Felipe", "Rivera", "1999-04-03", "feliperivera@gmail.com", MD5("alessiature01"), "Guatemala", "UNCRITMM666", "Felipe Rivera");
INSERT INTO contadino (id, nome, cognome, data_di_nascita, email, password, coordinate_geografiche, swift, titolare_conto) VALUES(9, "Diego", "Santos", "2001-06-02", "diegosantos@gmail.com", MD5("alessiature01"), "Guatemala", "UNCRITMM889", "Diego Santos");
INSERT INTO contadino (id, nome, cognome, data_di_nascita, email, password, coordinate_geografiche, swift, titolare_conto) VALUES(10, "Catarina", "Hernandez", "1985-07-23", "catarinahernandez@gmail.com", MD5("alessiature01"), "Guatemala", "UNCRIMMM999", "Catarina Hernandez");

INSERT INTO contadino (id, nome, cognome, data_di_nascita, email, password, coordinate_geografiche, swift, titolare_conto) VALUES(11, "Jose", "Gonzalez", "1984-05-03", "josegonzalez@gmail.com", MD5("alessiature01"), "Argentina", "UNCRATMM789", "Jose Gonzalez");
INSERT INTO contadino (id, nome, cognome, data_di_nascita, email, password, coordinate_geografiche, swift, titolare_conto) VALUES(12, "Jorge", "Martinez", "1975-03-02", "jorgemartinez@gmail.com", MD5("alessiature01"), "Argentina", "UNCRADMM749", "Jorge Martinez");
INSERT INTO contadino (id, nome, cognome, data_di_nascita, email, password, coordinate_geografiche, swift, titolare_conto) VALUES(13, "Ricardo ", "Perez", "1998-07-23", "ricardoperez@gmail.com", MD5("alessiature01"), "Argentina", "UNCRITEM779", "Ricardo Perez");
INSERT INTO contadino (id, nome, cognome, data_di_nascita, email, password, coordinate_geografiche, swift, titolare_conto) VALUES(14, "Raul", "Fernandez", "1999-10-23", "raulfernandez@gmail.com", MD5("alessiature01"), "Argentina", "UNERITMZ689", "Raul Fernandez");
INSERT INTO contadino (id, nome, cognome, data_di_nascita, email, password, coordinate_geografiche, swift, titolare_conto) VALUES(15, "Hugo", "Alvarez ", "1964-02-23", "hugoalvarez@gmail.com", MD5("alessiature01"), "Argentina", "UNCEITTT789", "Hugo Alvarez");
INSERT INTO contadino (id, nome, cognome, data_di_nascita, email, password, coordinate_geografiche, swift, titolare_conto) VALUES(16, "Sergio", "Diaz", "1954-02-23", "sergiodiaz@gmail.com", MD5("alessiature01"), "Argentina", "UNCRITEM789", "Sergio Diaz");
INSERT INTO contadino (id, nome, cognome, data_di_nascita, email, password, coordinate_geografiche, swift, titolare_conto) VALUES(17, "Alicia", "Alonso", "2002-02-23", "aliciaalonso@gmail.com", MD5("alessiature01"), "Argentina", "UNERITRZ789", "Alicia Alonso");
INSERT INTO contadino (id, nome, cognome, data_di_nascita, email, password, coordinate_geografiche, swift, titolare_conto) VALUES(18, "Ramona ", "Torres", "1999-04-03", "romonatorres@gmail.com", MD5("alessiature01"), "Argentina", "UNERITMM666", "Ramona Torres");
INSERT INTO contadino (id, nome, cognome, data_di_nascita, email, password, coordinate_geografiche, swift, titolare_conto) VALUES(19, "Enrique ", "Santos", "2001-06-02", "enriquesantos@gmail.com", MD5("alessiature01"), "Argentina", "UTCRITMM889", "Enrique Santos");
INSERT INTO contadino (id, nome, cognome, data_di_nascita, email, password, coordinate_geografiche, swift, titolare_conto) VALUES(20, "Osvaldo", "Ramirez", "1985-07-23", "osvaldoramirez@gmail.com", MD5("alessiature01"), "Argentina", "URCRIMMM999", "Ovalodo Ramirez");

INSERT INTO contadino (id, nome, cognome, data_di_nascita, email, password, coordinate_geografiche, swift, titolare_conto) VALUES(21, "Leonardo", "Monaco", "1984-05-03", "leonardomonaco@gmail.com", MD5("alessiature01"), "Italia", "UNCRITMM789", "Leonardo Monaco");
INSERT INTO contadino (id, nome, cognome, data_di_nascita, email, password, coordinate_geografiche, swift, titolare_conto) VALUES(22, "Francesco", "De Felice", "1975-03-02", "francescoannunziata@gmail.com", MD5("alessiature01"), "Italia", "UNCRITMM749", "Franscesco Annunziata");
INSERT INTO contadino (id, nome, cognome, data_di_nascita, email, password, coordinate_geografiche, swift, titolare_conto) VALUES(23, "Lorenzo", "Esposito", "1998-07-23", "lorenzoesposito@gmail.com", MD5("alessiature01"), "Italia", "UNCRITMM779", "Lorenzo Esposito");
INSERT INTO contadino (id, nome, cognome, data_di_nascita, email, password, coordinate_geografiche, swift, titolare_conto) VALUES(24, "Samuele", "Verdone", "1999-10-23", "samueleverdone@gmail.com", MD5("alessiature01"), "Italia", "UNCRITMZ689", "Samuele Verdone");
INSERT INTO contadino (id, nome, cognome, data_di_nascita, email, password, coordinate_geografiche, swift, titolare_conto) VALUES(25, "Isabella", "Rossi", "1964-02-23", "isabellarossi@gmail.com", MD5("alessiature01"), "Italia", "UNCRITTT789", "Isabella Rossi");
INSERT INTO contadino (id, nome, cognome, data_di_nascita, email, password, coordinate_geografiche, swift, titolare_conto) VALUES(26, "Sofia", "Matrone", "1954-02-23", "sofiamatrone@gmail.com", MD5("alessiature01"), "Italia", "UNCRITMM789", "Sofia Matrone");
INSERT INTO contadino (id, nome, cognome, data_di_nascita, email, password, coordinate_geografiche, swift, titolare_conto) VALUES(27, "Assunta", "De Vivo", "2002-02-23", "assuntadevivvo@gmail.com", MD5("alessiature01"), "Italia", "UNCRITRZ789", "Assunta De Vivo");
INSERT INTO contadino (id, nome, cognome, data_di_nascita, email, password, coordinate_geografiche, swift, titolare_conto) VALUES(28, "Maria", "Bianchi", "1999-04-03", "mariabianchi@gmail.com", MD5("alessiature01"), "Italia", "UNCRITMM666", "Maria Bianchi");
INSERT INTO contadino (id, nome, cognome, data_di_nascita, email, password, coordinate_geografiche, swift, titolare_conto) VALUES(29, "Annalisa", "Alfano", "2001-06-02", "annalisaalfano@gmail.com", MD5("alessiature01"), "Italia", "UNCRITMM889", "Annalisa Alfano");
INSERT INTO contadino (id, nome, cognome, data_di_nascita, email, password, coordinate_geografiche, swift, titolare_conto) VALUES(30, "Anna", "Casa", "1985-07-23", "annacasa@gmail.com", MD5("alessiature01"), "Italia", "UNCRIMMM999", "Anna Casa");

INSERT INTO contadino (id, nome, cognome, data_di_nascita, email, password, coordinate_geografiche, swift, titolare_conto) VALUES(31, "Guillermo ", "Sanchez ", "1984-05-03", "gugllermosanchez@gmail.com", MD5("alessiature01"), "Perù", "UNCRITMM789", "Guillermo Sanchez");
INSERT INTO contadino (id, nome, cognome, data_di_nascita, email, password, coordinate_geografiche, swift, titolare_conto) VALUES(32, "Maximo", "Lopez", "1975-03-02", "maximolopez@gmail.com", MD5("alessiature01"), "Perù", "UNCRITMM749", "Maximo Lopez");
INSERT INTO contadino (id, nome, cognome, data_di_nascita, email, password, coordinate_geografiche, swift, titolare_conto) VALUES(33, "Marina", "Gutierrez ", "1998-07-23", "marinagutierrez@gmail.com", MD5("alessiature01"), "Perù", "UNCRITMM779", "Marina Gutierrez");
INSERT INTO contadino (id, nome, cognome, data_di_nascita, email, password, coordinate_geografiche, swift, titolare_conto) VALUES(34, "Blanca", "Perez", "1999-10-23", "blancaprez@gmail.com", MD5("alessiature01"), "Perù", "UNCRITMZ689", "Blanca Perez");
INSERT INTO contadino (id, nome, cognome, data_di_nascita, email, password, coordinate_geografiche, swift, titolare_conto) VALUES(35, "Karina", "Cruz ", "1964-02-23", "karinacruz@gmail.com",MD5("alessiature01"), "Perù", "UNCRITTT789", "Karina Cruz");
INSERT INTO contadino (id, nome, cognome, data_di_nascita, email, password, coordinate_geografiche, swift, titolare_conto) VALUES(36, "Judith", "Mendoza", "1954-02-23", "judithmendoza@gmail.com", MD5("alessiature01"), "Argentina", "UNCRITMM789", "Judith Mendoza");
INSERT INTO contadino (id, nome, cognome, data_di_nascita, email, password, coordinate_geografiche, swift, titolare_conto) VALUES(37, "Reyna", "Delgado ", "2002-02-23", "reynadelga@gmail.com", MD5("alessiature01"), "Perù", "UNCRITRZ789", "Reyna Delgado");
INSERT INTO contadino (id, nome, cognome, data_di_nascita, email, password, coordinate_geografiche, swift, titolare_conto) VALUES(38, "Alexander", "Alvarez", "1999-04-03", "alexanderalvarez@gmail.com", MD5("alessiature01"), "Perù", "UNCRITMM666", "Alexander Alvarez");
INSERT INTO contadino (id, nome, cognome, data_di_nascita, email, password, coordinate_geografiche, swift, titolare_conto) VALUES(39, "Enric", "Santos", "2001-06-02", "enricsantos@gmail.com", MD5("alessiature01"), "Perù", "UNCRITMM889", "Diego Santos");
INSERT INTO contadino (id, nome, cognome, data_di_nascita, email, password, coordinate_geografiche, swift, titolare_conto) VALUES(40, "Ines", "Ortega", "1985-07-23", "inesortega@gmail.com", MD5("alessiature01"), "Perù", "UNCRIMMM999", "Ines Ortega");

/*Responsabile Catalogo*/
INSERT INTO responsabile_catalogo(id,email, password,nome, cognome) VALUES (1,"catalogo@gmail.com",MD5("catalogo"),"Mario","Rossi");

/*Responsabile Ordini*/
INSERT INTO responsabile_ordini(id,email, password,nome, cognome) VALUES (1,"ordini@gmail.com",MD5("ordini"),"Stefano","Bianchi");
